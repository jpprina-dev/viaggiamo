...
- [ ] T004 Review relevant `docs/` pages and record lifecycle placement +
      cross-feature impact baseline for this feature
...
- [ ] TXXX Verify documentation updates reflect lifecycle placement and
      cross-feature impact discovered during implementation
...
- Record consulted `docs/` pages in tasks that introduce new feature work
